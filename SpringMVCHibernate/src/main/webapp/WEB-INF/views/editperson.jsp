...
<body>
	<h1><local:message code="label.Edit_Person" /></h1>
	...
	<form:form action="${editAction}" commandName="person">
		<table>
			<c:if test="${!empty person.name}">
				<tr>
					<td><form:label path="photo" type="hidden">
						</form:label></td>
					<td><form:input type="hidden" path="photo" readonly="true"
							size="8" disabled="true" /> <form:hidden path="photo" /></td>
				</tr>
				<tr>
			...
			<tr>
				<td colspan="2"><input type="submit"
					value="<local:message code="label.Edit_Person" />" /></td>
			</tr>
		</table>
	</form:form>
</body>
